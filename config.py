...
_DEFAULTS: dict[str, Any] = {
    ...
    "jpeg_quality": 85,
    "jpeg_resize_1080": False,   # legacy — kept for migration
    "resize_enabled":   False,
    "resize_edge":      "shorter",   # "shorter" | "longer"
    "resize_value":     "1080",      # pixels as "1080" or percentage as "50%"
    "worker_count": os.cpu_count() or 4,
    "worker_count_p2": max(1, (os.cpu_count() or 4) // 2),
    "keyframes": {},          # {str(frame_index): target_luminance}
    "keyframe_radius": 30,    # blend radius in frames
}
